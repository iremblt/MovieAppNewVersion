    ...
    public static class MovieRepository
    {
        ...
        static MovieRepository()
        {
            _movies = new List<Movie>()
            {
                ...
                new Movie(){ //Crime/Drama/Thriller
                    MovieId=4,
                ...
                new Movie(){ //Advanture/Biography/Drama
                    MovieId=7,
                ...
                new Movie(){ //Advanture/Drama/Fantasy
                    MovieId=8,
                ...
                new Movie(){ //Advanture/Drama/Action
                    MovieId=9,
                ...
                new Movie(){ //Drama/Mystery/Sci-Fi
                    MovieId=10,
        ...
        {
            var movies = GetById(movie.MovieId);
            if (movies != null)
            {
                movies.MovieTitle = movie.MovieTitle;
                movies.MovieDescription = movie.MovieDescription;
                movies.MovieAbout = movie.MovieAbout;
                movies.MovieImage = movie.MovieImage;
              //  movies.CategoryId = movie.CategoryId;
            }
            /*foreach (var movies in _movies)
            {
                if (movies.MovieId == movie.MovieId)
                {
                    movies.MovieTitle = movie.MovieTitle;
                    movies.MovieDescription = movie.MovieDescription;
                    movies.MovieAbout = movie.MovieAbout;
                    movies.MovieImage = movie.MovieImage;
                    movies.MovieDirector = movie.MovieDirector;
                    movies.MovieCategoryId = movie.MovieCategoryId;
                    break;
                }
            }
            */
